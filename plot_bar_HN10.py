...
def plot_bar_2(persent_cluster, value_cluster, fig_title, main_dir, main_col):
    '''
    ...
    legend_color_map = create_color_map(intron_legend)
...
def create_color_map(intron_legend):
    """
...
def main():    
    ...
    for one_cell in cell_type:
        ...
        for cluster in sucess_clusters: #select clusters to plot
            ...
            plot_bar_2(persent_cluster, value_cluster, fig_title, main_dir, main_col) 
